...
import type { AbiPair, AbiPairInterface } from "../AbiPair";
...
export class AbiPair__factory {
  static readonly abi = _abi;
  static createInterface(): AbiPairInterface {
    return new utils.Interface(_abi) as AbiPairInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AbiPair {
    return new Contract(address, _abi, signerOrProvider) as AbiPair;
  }
}
